...
function stage3.stage_init(GameObject, Map)
	...
	table.insert(GameObject_ID, add_object(object_table[1], -150, 170))
...
--	add_object(object_table[2], 400, 50)
	...
	table.insert(GameObject_ID, add_object(object_table[5], -400, 150))
	table.insert(GameObject_ID, add_object(object_table[6], -300, 100))
	table.insert(GameObject_ID, add_object(object_table[5], 1000, 130))
	table.insert(GameObject_ID, add_object(object_table[6], 800, 110))
	table.insert(GameObject_ID, add_object(object_table[5], 1300, 125))
	table.insert(GameObject_ID, add_object(object_table[6], 1000, 90))
