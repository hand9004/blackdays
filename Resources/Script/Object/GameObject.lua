--[[ info {name, atk_pt, def_pt, hp, recognize_area, attack_range_X, attack_range_Y,
			move_speed, isEnemy, isHero, isControllable, isAreaAttack} ]]--

player = {info = {"player", 20, 5, 400, 300, 100, 10, 4.0, false, true, true, false},
...
player1 = {info = {"player1", 30, 5, 400, 300, 100, 1, 4.0, false, true, true, false},
...
enemy = {info = {"enemy", 15, 5, 200, 400, 400, 100, 2.0, true, false, false, true},
...
enemy1 = {info = {"enemy1", 10, 5, 200, 300, 100, 10, 3.0, true, false, false, false},
